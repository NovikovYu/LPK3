...
import { ConfirmEmailBoxRestyle, ConfirmEmailBoxWrapperRestyle, ConfirmEmailButtonRestyle, ConfirmEmailContentWrapperRestyle, ConfirmEmailHeadingRestyle, ConfirmEmailImgWrapperRestyle, ConfirmEmailMessageRestyle } from '@/feature/style-home';
                ...
                <ConfirmEmailBoxRestyle>
                    <ConfirmEmailContentWrapperRestyle>
                        ...
                        <ConfirmEmailMessageRestyle>
                            We sent an email to mymailverylongnameforexample@mail.com
                            Until you confirm the email, you will not be able to use 
