...
export const ForgotPasswordInputLabelRestyled = styled(InputLabel)(({theme}) => ({
...
export const ForgotPasswordHeadingFormRestyled = styled(Typography)(({theme}) => ({
  display:'flex', 
  alignItems:'center', 
  justifyContent:'space-between',
...
export const ForgotPasswordIconButtonRestyled = styled(IconButton)(({theme}) => ({
  [theme.breakpoints.down('sm')]: {
    fontSize: 'large',
    "& .MuiSvgIcon-root":{
      fontSize:'large',
...
export const ForgotPasswordInputFieldRestyled = styled(TextField)(({theme}) => ({
  marginTop: theme.spacing(2),
  marginBottom: theme.spacing(2),
  [theme.breakpoints.down('sm')]: {
